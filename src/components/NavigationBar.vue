<template>
  <nav class="navigation-bar" :class="{'navigation-bar--editor': styles.showEditor && !revisionContent, 'navigation-bar--light': light}">
    ...
    <div class="navigation-bar__inner navigation-bar__inner--left navigation-bar__inner--button">
      <button class="navigation-bar__button navigation-bar__button--close button" @click="close()" v-title="'Close StackEdit'"><icon-check-circle></icon-check-circle></button>
    ...
    <div class="navigation-bar__inner navigation-bar__inner--edit-pagedownButtons">
      ...
      <a :href="decodedUrl" class="navigation-bar__button button" v-title="'Help'"><icon-help-circle></icon-help-circle></a>
    </div>
  </nav>
</template>
...
export default {
  data: () => ({
    encodedUrl: 'aHR0cHM6Ly9mdWxzdGVjaC5naXRib29rLmlvL2RvY3MvbWFya2Rvd24tZm9yLWNvbmZsdWVuY2UvY29uZmx1ZW5jZS1jbG91ZC91c2FnZQ==',
    mounted: false,
    title: '',
    titleFocus: false,
    titleHover: false,
